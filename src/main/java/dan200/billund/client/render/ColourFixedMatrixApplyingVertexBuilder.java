...
/**
 * Copied from {@see com.mojang.blaze3d.vertex.MatrixApplyingVertexBuilder} to fix the fact that it doesn't respect the
 * default colour from DefaultColourVertexBuilder (seriously, why even bother subclassing it?)
 */
public class ColourFixedMatrixApplyingVertexBuilder extends DefaultColorVertexBuilder {
    ...
    public ColourFixedMatrixApplyingVertexBuilder(IVertexBuilder vertexBuilder, Matrix4f currentTransformMatrix, Matrix3f normalMatrix) {
    ...
    public void endVertex() {
        ...
        this.vertexBuilder
                ...
                .color(defaultRed / 255f, defaultGreen / 255f, defaultBlue / 255f, defaultAlpha / 255f)
                .tex(f, f1)
